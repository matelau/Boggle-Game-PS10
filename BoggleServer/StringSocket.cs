...
namespace CustomNetworking
{
    ...
    public class StringSocket
    {
        ...
        //set the player number for boggleGame
        private int player;
        ...
        //set the game number for boggleGame
        private int game;
        ...
        /// <summary>
        /// Checks whether or not the underlying comment is connected or not
        /// </summary>
        /// <returns></returns>
        ...
        /// <summary>
        /// Gracefully shutsdown the socket
        /// </summary>
